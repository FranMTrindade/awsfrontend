            ...
            <Paper style={{ flex: 1 }}>
              <Grid item container style={{ height: '100%' }} direction="column">
                ...
                <Grid item style={{ margin: 10 }}>
                  ...
                  <Button 
                    style={{ marginRight: 10, color: "#232F3E", borderColor: "#232F3E" }} variant="outlined" size="small" disableElevation onClick={props.onPublicMessage}>Mensagem pública</Button>
                  }
